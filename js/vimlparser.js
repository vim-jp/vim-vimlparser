...
VimLParser.prototype.find_command = function() {
    ...
    if (this.vspec) {
        var __c7 = this.vspec_additional_commands;
...
VimLParser.prototype.vspec_additional_commands = [{"name":"describe", "flags":"", "parser":"parse_cmd_common"}, {"name":"end", "flags":"", "parser":"parse_cmd_common"}, {"name":"it", "flags":"", "parser":"parse_cmd_common"}, {"name":"before", "flags":"", "parser":"parse_cmd_common"}, {"name":"after", "flags":"", "parser":"parse_cmd_common"}, {"name":"context", "flags":"", "parser":"parse_cmd_common"}];
...
StringReader.prototype.__init__ = function(lines) {
    ...
    while (lnum < viml_len(lines)) {
        var col = 0;
        var __c8 = viml_split(lines[lnum], "\\zs");
        ...
        while (lnum + 1 < viml_len(lines) && viml_eqregh(lines[lnum + 1], "^\\s*\\\\")) {
            var skip = TRUE;
            var col = 0;
            var __c9 = viml_split(lines[lnum + 1], "\\zs");
...
StringReader.prototype.getstr = function(begin, end) {
    var r = "";
    var __c10 = viml_range(begin.i, end.i - 1);
...
Compiler.prototype.compile_function = function(node) {
    ...
    if (!viml_empty(rlist)) {
        ...
        var __c12 = viml_range(viml_len(rlist));
...
Compiler.prototype.compile_if = function(node) {
    ...
    this.compile_body(node.body);
    this.decindent();
    var __c13 = node.elseif;
    for (var __i13 = 0; __i13 < __c13.length; ++__i13) {
        var enode = __c13[__i13];
...
Compiler.prototype.compile_try = function(node) {
    ...
    this.incindent("  ");
    this.compile_body(node.body);
    var __c14 = node.catch;
    for (var __i14 = 0; __i14 < __c14.length; ++__i14) {
        var cnode = __c14[__i14];
...
Compiler.prototype.escape_string = function(str) {
    var m = {"\n":"\\n", "\t":"\\t", "\r":"\\r"};
    var out = "\"";
    var __c15 = viml_range(viml_len(str));
...
RegexpParser.prototype.get_token_sq_char_class = function() {
    ...
    if (this.reader.p(0) == "[" && this.reader.p(1) == ":") {
        ...
        if (this.reader.p(0) == ":" && this.reader.p(1) == "]") {
            this.reader.seek_cur(2);
            var __c16 = class_names;
            for (var __i16 = 0; __i16 < __c16.length; ++__i16) {
                var name = __c16[__i16];
                if (r == name) {
                    return "[:" + name + ":]";
                }
            }
