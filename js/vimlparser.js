...
VimLParser.prototype.parse_argopt = function() {
    while (this.reader.p(0) == "+" && this.reader.p(1) == "+") {
        ...
        if (viml_eqregh(s, "^++bin\\>")) {
            ...
            throw Err("E474: Invalid Argument", this.reader.pos());
        }
        else {
            break;
        }
...
VimLParser.prototype.neovim_additional_commands = [{"name": "tnoremap", "minlen": 1, "flags": "EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN", "parser": "parse_cmd_common"}]
