...
class VimLParser:
    def __init__(self, neovim=False):
...
# FIXME: validate argument
    ...
    neovim_additional_commands = [AttributeDict({"name": "tnoremap", "minlen": 1, "flags": "EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN", "parser": "parse_cmd_common"})]
