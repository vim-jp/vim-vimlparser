...
class VimLParser:
    ...
    vspec_additional_commands = [AttributeDict({"name": "describe", "flags": "", "parser": "parse_cmd_common"}), AttributeDict({"name": "end", "flags": "", "parser": "parse_cmd_common"}), AttributeDict({"name": "it", "flags": "", "parser": "parse_cmd_common"}), AttributeDict({"name": "before", "flags": "", "parser": "parse_cmd_common"}), AttributeDict({"name": "after", "flags": "", "parser": "parse_cmd_common"}), AttributeDict({"name": "context", "flags": "", "parser": "parse_cmd_common"})]
